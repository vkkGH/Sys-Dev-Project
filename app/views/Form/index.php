	...
	<div class="container">
      ...
      <select class="form-control" id="participant_gender" name="participant_gender">
        ...
        <option value="other">Other</option>
			...
			<label class='form-label'>Allergies:<input type='text' name='allergies' class='form-control' /></label><br>  
			...
			<label class='form-label'>Any medicaments that need to be taken during club activities:<input type='text' name='meds' class='form-control' /></label><br>
			...
			<label class='form-label'>Do you consent to letting the club use photos of the participant for promotion purposes?:</label>
			<select class="form-control" id="promotion" name="promotion">
				<option value="0">No</option>
				<option value="1">Yes</option>
			</select>
			
			<label class='form-label'>Do you consent to letting the club transport the participant during water polo events (such as matches) if needed?:</label>
			<select class="form-control" id="transport" name="transport">
				<option value="0">No</option>
				<option value="1">Yes</option>
			</select>
			
			<label class='form-label'>Do you want to be notified of potential volunteer opportunities within the club?:</label>
